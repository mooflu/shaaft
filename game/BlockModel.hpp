...
public:
    ...
    void setPracticeMode( bool isPractice){
        _practiceMode = isPractice;
    }
    bool isPracticeMode( void){
    ...
    void rotateBlock( const Point3Di &r1,
		      const Point3Di &r2,
		      const Point3Di &r3,
		      const Point3Di &axis);

    void registerView( BlockView *view)
    {
	_view = view;
    }
...
private:
    ...
    void clearAndDeleteElementList( ElementList* &elemList,
    				    DeleteType deleteList=DeleteElementsAndList);
    void cleanup( void);
