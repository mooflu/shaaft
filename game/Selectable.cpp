...
ImageOnlySelectable::ImageOnlySelectable(
                                       bool enabled,
                                       const BoundingBox &rect,
                                       const string &text,
                                       const string &info,
...
void FloatSelectable::draw( const Point2Di &offset)
{
    ...
    _icons->DrawC(
        _slider,
        _boundingBox.min.x + offset.x+221+_sliderOffset,
        _boundingBox.min.y + offset.y+10, 1.1f, 0.5f);
    _icons->DrawC(
        _doubleArrow,
        _boundingBox.min.x + offset.x+152+_sliderOffset+_xPos,
