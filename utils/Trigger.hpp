...
struct Trigger
{
    ...
    Trigger( void):
        type(eUnknownTrigger), isDown(false), key(0), modifier(0), x(0.0f), y(0.0f) {}
    Trigger( TriggerTypeEnum triggerType, bool isDown, int key, int mod): 
        type(triggerType), isDown(isDown), key(key), modifier(mod), x(0.0f), y(0.0f) {}
    Trigger( float x, float y ): 
        type(eMotionTrigger), isDown(false), key(0), modifier(0), x(x), y(y) {}
    Trigger( const std::string &t ): 
        type(eTextTrigger), isDown(false), key(0), modifier(0), x(0.0f), y(0.0f), text(t) {}
