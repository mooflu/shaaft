...
void ZeroConf::ServiceBrowseReply(
	DNSServiceRef             sdRef,
...
void ZeroConf::ServiceResolveReply(
	 DNSServiceRef            sdRef,
	 DNSServiceFlags          flags,
	 uint32_t                 interfaceIndex,
	 DNSServiceErrorType      errorCode,
...
void ZeroConf::ServiceRegisterReply(
	 DNSServiceRef            sdRef,
	 DNSServiceFlags          flags,
	 DNSServiceErrorType      errorCode,
	 const char               *name,
...
bool ZeroConf::resolveService( const ServiceRecord &serviceRecord, ResolvedServiceRecord &resultRecord)
{
	...
	0, //flags
	_interfaceIndex,
	serviceRecord.Name.c_str(),
	serviceRecord.Type.c_str(),
	serviceRecord.Domain.c_str(),
	ServiceResolveReply,
	this);
